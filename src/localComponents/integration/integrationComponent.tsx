...
// import ChatTicketing from "./chat/chat";
...
const IntegrationComponent: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    { icon: <PaymentGatewayIcon />, label: "Payment Gateway", id: "payment" },
    { icon: <PosIcon />, label: "Pos", id: "pos" },
    { icon: <SmsIcon />, label: "SMS", id: "sms" },
    { icon: <EmailIcon />, label: "Email", id: "email" },
    { icon: <DeliveryIcon />, label: "Delivery Management System", id: "delivery" },
    { icon: <WebhookIcon />, label: "Web hook", id: "webhook" },
    { icon: <GoogleAnalyticsIcon />, label: "Google Analytics", id: "analytics" },
    { icon: <ChatTicketingIcon />, label: "Chat & Ticketing", id: "chat" },
    { icon: <WhatsAppIcon />, label: "WhatsApp", id: "whatsapp" },
    { icon: <GoogleCalendarIcon />, label: "Google Calendar", id: "calendar" },
    { icon: <ZapierIcon />, label: "Zapier", id: "zapier" },
  ];
    ...
    return (
      <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <div className="flex-1 p-4 overflow-y-auto">
          {selectedItem === "Payment Gateway" && <Payment />}
           {selectedItem === "Pos" && <Pos />}
         {selectedItem === "SMS" && <Sms/>}
          {selectedItem === "Email" && <Email />}
           {selectedItem === "Delivery Management System" && <Delivery/>}
          {selectedItem === "Web hook" && <Webhook />}
         {/* {selectedItem === "Google Analytics" && <GoogleAnalytics/>}
          {selectedItem === "Chat & Ticketing" && <ChatTicketing />} */}
          {selectedItem === "WhatsApp" && <WhatsApp/>}
  {/*   {selectedItem === "Google Calendar" && <GoogleCalendar />} */}
